...
let s:cols = split("OP CL CP QU GL NS EX SY IS PR PO NU AL HL ID IN HY BA BB B2 ZW CM WJ H2 H3 JL JV JT RI")
...
call extend(s:tmp, [[0x085E,0x085E,'AL'],[0x08A0,0x08B2,'AL'],[0x08E4,0x0903,'CM']])
...
call extend(s:tmp, [[0x0B01,0x0B03,'CM'],[0x0B05,0x0B0C,'AL'],[0x0B0F,0x0B10,'AL']])
call extend(s:tmp, [[0x0B13,0x0B28,'AL'],[0x0B2A,0x0B30,'AL'],[0x0B32,0x0B33,'AL']])
call extend(s:tmp, [[0x0B35,0x0B39,'AL'],[0x0B3C,0x0B3C,'CM'],[0x0B3D,0x0B3D,'AL']])
call extend(s:tmp, [[0x0B3E,0x0B44,'CM'],[0x0B47,0x0B48,'CM'],[0x0B4B,0x0B4D,'CM']])
call extend(s:tmp, [[0x0B56,0x0B57,'CM'],[0x0B5C,0x0B5D,'AL'],[0x0B5F,0x0B61,'AL']])
call extend(s:tmp, [[0x0B62,0x0B63,'CM'],[0x0B66,0x0B6F,'NU'],[0x0B70,0x0B77,'AL']])
call extend(s:tmp, [[0x0B82,0x0B82,'CM'],[0x0B83,0x0B83,'AL'],[0x0B85,0x0B8A,'AL']])
call extend(s:tmp, [[0x0B8E,0x0B90,'AL'],[0x0B92,0x0B95,'AL'],[0x0B99,0x0B9A,'AL']])
call extend(s:tmp, [[0x0B9C,0x0B9C,'AL'],[0x0B9E,0x0B9F,'AL'],[0x0BA3,0x0BA4,'AL']])
call extend(s:tmp, [[0x0BA8,0x0BAA,'AL'],[0x0BAE,0x0BB9,'AL'],[0x0BBE,0x0BC2,'CM']])
call extend(s:tmp, [[0x0BC6,0x0BC8,'CM'],[0x0BCA,0x0BCD,'CM'],[0x0BD0,0x0BD0,'AL']])
call extend(s:tmp, [[0x0BD7,0x0BD7,'CM'],[0x0BE6,0x0BEF,'NU'],[0x0BF0,0x0BF8,'AL']])
call extend(s:tmp, [[0x0BF9,0x0BF9,'PR'],[0x0BFA,0x0BFA,'AL'],[0x0C00,0x0C03,'CM']])
call extend(s:tmp, [[0x0C05,0x0C0C,'AL'],[0x0C0E,0x0C10,'AL'],[0x0C12,0x0C28,'AL']])
call extend(s:tmp, [[0x0C2A,0x0C39,'AL'],[0x0C3D,0x0C3D,'AL'],[0x0C3E,0x0C44,'CM']])
call extend(s:tmp, [[0x0C46,0x0C48,'CM'],[0x0C4A,0x0C4D,'CM'],[0x0C55,0x0C56,'CM']])
call extend(s:tmp, [[0x0C58,0x0C59,'AL'],[0x0C60,0x0C61,'AL'],[0x0C62,0x0C63,'CM']])
call extend(s:tmp, [[0x0C66,0x0C6F,'NU'],[0x0C78,0x0C7F,'AL'],[0x0C81,0x0C83,'CM']])
call extend(s:tmp, [[0x0C85,0x0C8C,'AL'],[0x0C8E,0x0C90,'AL'],[0x0C92,0x0CA8,'AL']])
call extend(s:tmp, [[0x0CAA,0x0CB3,'AL'],[0x0CB5,0x0CB9,'AL'],[0x0CBC,0x0CBC,'CM']])
call extend(s:tmp, [[0x0CBD,0x0CBD,'AL'],[0x0CBE,0x0CC4,'CM'],[0x0CC6,0x0CC8,'CM']])
call extend(s:tmp, [[0x0CCA,0x0CCD,'CM'],[0x0CD5,0x0CD6,'CM'],[0x0CDE,0x0CDE,'AL']])
call extend(s:tmp, [[0x0CE0,0x0CE1,'AL'],[0x0CE2,0x0CE3,'CM'],[0x0CE6,0x0CEF,'NU']])
call extend(s:tmp, [[0x0CF1,0x0CF2,'AL'],[0x0D01,0x0D03,'CM'],[0x0D05,0x0D0C,'AL']])
call extend(s:tmp, [[0x0D0E,0x0D10,'AL'],[0x0D12,0x0D3A,'AL'],[0x0D3D,0x0D3D,'AL']])
call extend(s:tmp, [[0x0D3E,0x0D44,'CM'],[0x0D46,0x0D48,'CM'],[0x0D4A,0x0D4D,'CM']])
call extend(s:tmp, [[0x0D4E,0x0D4E,'AL'],[0x0D57,0x0D57,'CM'],[0x0D60,0x0D61,'AL']])
call extend(s:tmp, [[0x0D62,0x0D63,'CM'],[0x0D66,0x0D6F,'NU'],[0x0D70,0x0D75,'AL']])
call extend(s:tmp, [[0x0D79,0x0D79,'PO'],[0x0D7A,0x0D7F,'AL'],[0x0D82,0x0D83,'CM']])
call extend(s:tmp, [[0x0D85,0x0D96,'AL'],[0x0D9A,0x0DB1,'AL'],[0x0DB3,0x0DBB,'AL']])
call extend(s:tmp, [[0x0DBD,0x0DBD,'AL'],[0x0DC0,0x0DC6,'AL'],[0x0DCA,0x0DCA,'CM']])
call extend(s:tmp, [[0x0DCF,0x0DD4,'CM'],[0x0DD6,0x0DD6,'CM'],[0x0DD8,0x0DDF,'CM']])
call extend(s:tmp, [[0x0DE6,0x0DEF,'NU'],[0x0DF2,0x0DF3,'CM'],[0x0DF4,0x0DF4,'AL']])
call extend(s:tmp, [[0x0E01,0x0E3A,'SA'],[0x0E3F,0x0E3F,'PR'],[0x0E40,0x0E4E,'SA']])
call extend(s:tmp, [[0x0E4F,0x0E4F,'AL'],[0x0E50,0x0E59,'NU'],[0x0E5A,0x0E5B,'BA']])
call extend(s:tmp, [[0x0E81,0x0E82,'SA'],[0x0E84,0x0E84,'SA'],[0x0E87,0x0E88,'SA']])
call extend(s:tmp, [[0x0E8A,0x0E8A,'SA'],[0x0E8D,0x0E8D,'SA'],[0x0E94,0x0E97,'SA']])
call extend(s:tmp, [[0x0E99,0x0E9F,'SA'],[0x0EA1,0x0EA3,'SA'],[0x0EA5,0x0EA5,'SA']])
call extend(s:tmp, [[0x0EA7,0x0EA7,'SA'],[0x0EAA,0x0EAB,'SA'],[0x0EAD,0x0EB9,'SA']])
call extend(s:tmp, [[0x0EBB,0x0EBD,'SA'],[0x0EC0,0x0EC4,'SA'],[0x0EC6,0x0EC6,'SA']])
call extend(s:tmp, [[0x0EC8,0x0ECD,'SA'],[0x0ED0,0x0ED9,'NU'],[0x0EDC,0x0EDF,'SA']])
call extend(s:tmp, [[0x0F00,0x0F00,'AL'],[0x0F01,0x0F04,'BB'],[0x0F05,0x0F05,'AL']])
call extend(s:tmp, [[0x0F06,0x0F07,'BB'],[0x0F08,0x0F08,'GL'],[0x0F09,0x0F0A,'BB']])
call extend(s:tmp, [[0x0F0B,0x0F0B,'BA'],[0x0F0C,0x0F0C,'GL'],[0x0F0D,0x0F11,'EX']])
call extend(s:tmp, [[0x0F12,0x0F12,'GL'],[0x0F13,0x0F13,'AL'],[0x0F14,0x0F14,'EX']])
call extend(s:tmp, [[0x0F15,0x0F17,'AL'],[0x0F18,0x0F19,'CM'],[0x0F1A,0x0F1F,'AL']])
call extend(s:tmp, [[0x0F20,0x0F29,'NU'],[0x0F2A,0x0F33,'AL'],[0x0F34,0x0F34,'BA']])
call extend(s:tmp, [[0x0F35,0x0F35,'CM'],[0x0F36,0x0F36,'AL'],[0x0F37,0x0F37,'CM']])
call extend(s:tmp, [[0x0F38,0x0F38,'AL'],[0x0F39,0x0F39,'CM'],[0x0F3A,0x0F3A,'OP']])
call extend(s:tmp, [[0x0F3B,0x0F3B,'CL'],[0x0F3C,0x0F3C,'OP'],[0x0F3D,0x0F3D,'CL']])
call extend(s:tmp, [[0x0F3E,0x0F3F,'CM'],[0x0F40,0x0F47,'AL'],[0x0F49,0x0F6C,'AL']])
call extend(s:tmp, [[0x0F71,0x0F7E,'CM'],[0x0F7F,0x0F7F,'BA'],[0x0F80,0x0F84,'CM']])
call extend(s:tmp, [[0x0F85,0x0F85,'BA'],[0x0F86,0x0F87,'CM'],[0x0F88,0x0F8C,'AL']])
call extend(s:tmp, [[0x0F8D,0x0F97,'CM'],[0x0F99,0x0FBC,'CM'],[0x0FBE,0x0FBF,'BA']])
call extend(s:tmp, [[0x0FC0,0x0FC5,'AL'],[0x0FC6,0x0FC6,'CM'],[0x0FC7,0x0FCC,'AL']])
call extend(s:tmp, [[0x0FCE,0x0FCF,'AL'],[0x0FD0,0x0FD1,'BB'],[0x0FD2,0x0FD2,'BA']])
call extend(s:tmp, [[0x0FD3,0x0FD3,'BB'],[0x0FD4,0x0FD8,'AL'],[0x0FD9,0x0FDA,'GL']])
call extend(s:tmp, [[0x1000,0x103F,'SA'],[0x1040,0x1049,'NU'],[0x104A,0x104B,'BA']])
call extend(s:tmp, [[0x104C,0x104F,'AL'],[0x1050,0x108F,'SA'],[0x1090,0x1099,'NU']])
call extend(s:tmp, [[0x109A,0x109F,'SA'],[0x10A0,0x10C5,'AL'],[0x10C7,0x10C7,'AL']])
call extend(s:tmp, [[0x10CD,0x10CD,'AL'],[0x10D0,0x10FF,'AL'],[0x1100,0x115F,'JL']])
call extend(s:tmp, [[0x1160,0x11A7,'JV'],[0x11A8,0x11FF,'JT'],[0x1200,0x1248,'AL']])
call extend(s:tmp, [[0x124A,0x124D,'AL'],[0x1250,0x1256,'AL'],[0x1258,0x1258,'AL']])
call extend(s:tmp, [[0x125A,0x125D,'AL'],[0x1260,0x1288,'AL'],[0x128A,0x128D,'AL']])
call extend(s:tmp, [[0x1290,0x12B0,'AL'],[0x12B2,0x12B5,'AL'],[0x12B8,0x12BE,'AL']])
call extend(s:tmp, [[0x12C0,0x12C0,'AL'],[0x12C2,0x12C5,'AL'],[0x12C8,0x12D6,'AL']])
call extend(s:tmp, [[0x12D8,0x1310,'AL'],[0x1312,0x1315,'AL'],[0x1318,0x135A,'AL']])
call extend(s:tmp, [[0x135D,0x135F,'CM'],[0x1360,0x1360,'AL'],[0x1361,0x1361,'BA']])
call extend(s:tmp, [[0x1362,0x137C,'AL'],[0x1380,0x1399,'AL'],[0x13A0,0x13F4,'AL']])
...
call extend(s:tmp, [[0x1880,0x18A8,'AL'],[0x18A9,0x18A9,'CM'],[0x18AA,0x18AA,'AL']])
call extend(s:tmp, [[0x18B0,0x18F5,'AL'],[0x1900,0x191E,'AL'],[0x1920,0x192B,'CM']])
call extend(s:tmp, [[0x1930,0x193B,'CM'],[0x1940,0x1940,'AL'],[0x1944,0x1945,'EX']])
call extend(s:tmp, [[0x1946,0x194F,'NU'],[0x1950,0x196D,'SA'],[0x1970,0x1974,'SA']])
call extend(s:tmp, [[0x1980,0x19AB,'SA'],[0x19B0,0x19C9,'SA'],[0x19D0,0x19D9,'NU']])
call extend(s:tmp, [[0x19DA,0x19DA,'SA'],[0x19DE,0x19DF,'SA'],[0x19E0,0x1A16,'AL']])
call extend(s:tmp, [[0x1A17,0x1A1B,'CM'],[0x1A1E,0x1A1F,'AL'],[0x1A20,0x1A5E,'SA']])
call extend(s:tmp, [[0x1A60,0x1A7C,'SA'],[0x1A7F,0x1A7F,'CM'],[0x1A80,0x1A89,'NU']])
call extend(s:tmp, [[0x1A90,0x1A99,'NU'],[0x1AA0,0x1AAD,'SA'],[0x1AB0,0x1ABE,'CM']])
call extend(s:tmp, [[0x1B00,0x1B04,'CM'],[0x1B05,0x1B33,'AL'],[0x1B34,0x1B44,'CM']])
call extend(s:tmp, [[0x1B45,0x1B4B,'AL'],[0x1B50,0x1B59,'NU'],[0x1B5A,0x1B5B,'BA']])
call extend(s:tmp, [[0x1B5C,0x1B5C,'AL'],[0x1B5D,0x1B60,'BA'],[0x1B61,0x1B6A,'AL']])
call extend(s:tmp, [[0x1B6B,0x1B73,'CM'],[0x1B74,0x1B7C,'AL'],[0x1B80,0x1B82,'CM']])
call extend(s:tmp, [[0x1B83,0x1BA0,'AL'],[0x1BA1,0x1BAD,'CM'],[0x1BAE,0x1BAF,'AL']])
call extend(s:tmp, [[0x1BB0,0x1BB9,'NU'],[0x1BBA,0x1BE5,'AL'],[0x1BE6,0x1BF3,'CM']])
call extend(s:tmp, [[0x1BFC,0x1C23,'AL'],[0x1C24,0x1C37,'CM'],[0x1C3B,0x1C3F,'BA']])
call extend(s:tmp, [[0x1C40,0x1C49,'NU'],[0x1C4D,0x1C4F,'AL'],[0x1C50,0x1C59,'NU']])
call extend(s:tmp, [[0x1C5A,0x1C7D,'AL'],[0x1C7E,0x1C7F,'BA'],[0x1CC0,0x1CC7,'AL']])
...
call extend(s:tmp, [[0x1D00,0x1DBF,'AL'],[0x1DC0,0x1DF5,'CM'],[0x1DFC,0x1DFF,'CM']])
...
call extend(s:tmp, [[0x200B,0x200B,'ZW'],[0x200C,0x200F,'CM'],[0x2010,0x2010,'BA']])
call extend(s:tmp, [[0x2011,0x2011,'GL'],[0x2012,0x2013,'BA'],[0x2014,0x2014,'B2']])
call extend(s:tmp, [[0x2015,0x2016,'AI'],[0x2017,0x2017,'AL'],[0x2018,0x2019,'QU']])
call extend(s:tmp, [[0x201A,0x201A,'OP'],[0x201B,0x201D,'QU'],[0x201E,0x201E,'OP']])
call extend(s:tmp, [[0x201F,0x201F,'QU'],[0x2020,0x2021,'AI'],[0x2022,0x2023,'AL']])
call extend(s:tmp, [[0x2024,0x2026,'IN'],[0x2027,0x2027,'BA'],[0x2028,0x2029,'BK']])
call extend(s:tmp, [[0x202A,0x202E,'CM'],[0x202F,0x202F,'GL'],[0x2030,0x2037,'PO']])
call extend(s:tmp, [[0x2038,0x2038,'AL'],[0x2039,0x203A,'QU'],[0x203B,0x203B,'AI']])
call extend(s:tmp, [[0x203C,0x203D,'NS'],[0x203E,0x2043,'AL'],[0x2044,0x2044,'IS']])
call extend(s:tmp, [[0x2045,0x2045,'OP'],[0x2046,0x2046,'CL'],[0x2047,0x2049,'NS']])
call extend(s:tmp, [[0x204A,0x2055,'AL'],[0x2056,0x2056,'BA'],[0x2057,0x2057,'AL']])
call extend(s:tmp, [[0x2058,0x205B,'BA'],[0x205C,0x205C,'AL'],[0x205D,0x205F,'BA']])
call extend(s:tmp, [[0x2060,0x2060,'WJ'],[0x2061,0x2064,'AL'],[0x2066,0x206F,'CM']])
call extend(s:tmp, [[0x2070,0x2071,'AL'],[0x2074,0x2074,'AI'],[0x2075,0x207C,'AL']])
call extend(s:tmp, [[0x207D,0x207D,'OP'],[0x207E,0x207E,'CL'],[0x207F,0x207F,'AI']])
call extend(s:tmp, [[0x2080,0x2080,'AL'],[0x2081,0x2084,'AI'],[0x2085,0x208C,'AL']])
call extend(s:tmp, [[0x208D,0x208D,'OP'],[0x208E,0x208E,'CL'],[0x2090,0x209C,'AL']])
call extend(s:tmp, [[0x20A0,0x20A6,'PR'],[0x20A7,0x20A7,'PO'],[0x20A8,0x20B5,'PR']])
call extend(s:tmp, [[0x20B6,0x20B6,'PO'],[0x20B7,0x20BA,'PR'],[0x20BB,0x20BB,'PO']])
call extend(s:tmp, [[0x20BC,0x20CF,'PR'],[0x20D0,0x20F0,'CM'],[0x2100,0x2102,'AL']])
call extend(s:tmp, [[0x2103,0x2103,'PO'],[0x2104,0x2104,'AL'],[0x2105,0x2105,'AI']])
call extend(s:tmp, [[0x2106,0x2108,'AL'],[0x2109,0x2109,'PO'],[0x210A,0x2112,'AL']])
call extend(s:tmp, [[0x2113,0x2113,'AI'],[0x2114,0x2115,'AL'],[0x2116,0x2116,'PR']])
call extend(s:tmp, [[0x2117,0x2120,'AL'],[0x2121,0x2122,'AI'],[0x2123,0x212A,'AL']])
call extend(s:tmp, [[0x212B,0x212B,'AI'],[0x212C,0x2153,'AL'],[0x2154,0x2155,'AI']])
call extend(s:tmp, [[0x2156,0x215A,'AL'],[0x215B,0x215B,'AI'],[0x215C,0x215D,'AL']])
call extend(s:tmp, [[0x215E,0x215E,'AI'],[0x215F,0x215F,'AL'],[0x2160,0x216B,'AI']])
call extend(s:tmp, [[0x216C,0x216F,'AL'],[0x2170,0x2179,'AI'],[0x217A,0x2188,'AL']])
call extend(s:tmp, [[0x2189,0x2189,'AI'],[0x2190,0x2199,'AI'],[0x219A,0x21D1,'AL']])
call extend(s:tmp, [[0x21D2,0x21D2,'AI'],[0x21D3,0x21D3,'AL'],[0x21D4,0x21D4,'AI']])
call extend(s:tmp, [[0x21D5,0x21FF,'AL'],[0x2200,0x2200,'AI'],[0x2201,0x2201,'AL']])
call extend(s:tmp, [[0x2202,0x2203,'AI'],[0x2204,0x2206,'AL'],[0x2207,0x2208,'AI']])
call extend(s:tmp, [[0x2209,0x220A,'AL'],[0x220B,0x220B,'AI'],[0x220C,0x220E,'AL']])
call extend(s:tmp, [[0x220F,0x220F,'AI'],[0x2210,0x2210,'AL'],[0x2211,0x2211,'AI']])
call extend(s:tmp, [[0x2212,0x2213,'PR'],[0x2214,0x2214,'AL'],[0x2215,0x2215,'AI']])
call extend(s:tmp, [[0x2216,0x2219,'AL'],[0x221A,0x221A,'AI'],[0x221B,0x221C,'AL']])
call extend(s:tmp, [[0x221D,0x2220,'AI'],[0x2221,0x2222,'AL'],[0x2223,0x2223,'AI']])
call extend(s:tmp, [[0x2224,0x2224,'AL'],[0x2225,0x2225,'AI'],[0x2226,0x2226,'AL']])
call extend(s:tmp, [[0x2227,0x222C,'AI'],[0x222D,0x222D,'AL'],[0x222E,0x222E,'AI']])
call extend(s:tmp, [[0x222F,0x2233,'AL'],[0x2234,0x2237,'AI'],[0x2238,0x223B,'AL']])
call extend(s:tmp, [[0x223C,0x223D,'AI'],[0x223E,0x2247,'AL'],[0x2248,0x2248,'AI']])
call extend(s:tmp, [[0x2249,0x224B,'AL'],[0x224C,0x224C,'AI'],[0x224D,0x2251,'AL']])
call extend(s:tmp, [[0x2252,0x2252,'AI'],[0x2253,0x225F,'AL'],[0x2260,0x2261,'AI']])
call extend(s:tmp, [[0x2262,0x2263,'AL'],[0x2264,0x2267,'AI'],[0x2268,0x2269,'AL']])
call extend(s:tmp, [[0x226A,0x226B,'AI'],[0x226C,0x226D,'AL'],[0x226E,0x226F,'AI']])
call extend(s:tmp, [[0x2270,0x2281,'AL'],[0x2282,0x2283,'AI'],[0x2284,0x2285,'AL']])
call extend(s:tmp, [[0x2286,0x2287,'AI'],[0x2288,0x2294,'AL'],[0x2295,0x2295,'AI']])
call extend(s:tmp, [[0x2296,0x2298,'AL'],[0x2299,0x2299,'AI'],[0x229A,0x22A4,'AL']])
call extend(s:tmp, [[0x22A5,0x22A5,'AI'],[0x22A6,0x22BE,'AL'],[0x22BF,0x22BF,'AI']])
call extend(s:tmp, [[0x22C0,0x2307,'AL'],[0x2308,0x2308,'OP'],[0x2309,0x2309,'CL']])
call extend(s:tmp, [[0x230A,0x230A,'OP'],[0x230B,0x230B,'CL'],[0x230C,0x2311,'AL']])
call extend(s:tmp, [[0x2312,0x2312,'AI'],[0x2313,0x2319,'AL'],[0x231A,0x231B,'ID']])
call extend(s:tmp, [[0x231C,0x2328,'AL'],[0x2329,0x2329,'OP'],[0x232A,0x232A,'CL']])
call extend(s:tmp, [[0x232B,0x23EF,'AL'],[0x23F0,0x23F3,'ID'],[0x23F4,0x23FA,'AL']])
call extend(s:tmp, [[0x2400,0x2426,'AL'],[0x2440,0x244A,'AL'],[0x2460,0x24FE,'AI']])
call extend(s:tmp, [[0x24FF,0x24FF,'AL'],[0x2500,0x254B,'AI'],[0x254C,0x254F,'AL']])
call extend(s:tmp, [[0x2550,0x2574,'AI'],[0x2575,0x257F,'AL'],[0x2580,0x258F,'AI']])
call extend(s:tmp, [[0x2590,0x2591,'AL'],[0x2592,0x2595,'AI'],[0x2596,0x259F,'AL']])
call extend(s:tmp, [[0x25A0,0x25A1,'AI'],[0x25A2,0x25A2,'AL'],[0x25A3,0x25A9,'AI']])
call extend(s:tmp, [[0x25AA,0x25B1,'AL'],[0x25B2,0x25B3,'AI'],[0x25B4,0x25B5,'AL']])
call extend(s:tmp, [[0x25B6,0x25B7,'AI'],[0x25B8,0x25BB,'AL'],[0x25BC,0x25BD,'AI']])
call extend(s:tmp, [[0x25BE,0x25BF,'AL'],[0x25C0,0x25C1,'AI'],[0x25C2,0x25C5,'AL']])
call extend(s:tmp, [[0x25C6,0x25C8,'AI'],[0x25C9,0x25CA,'AL'],[0x25CB,0x25CB,'AI']])
call extend(s:tmp, [[0x25CC,0x25CD,'AL'],[0x25CE,0x25D1,'AI'],[0x25D2,0x25E1,'AL']])
call extend(s:tmp, [[0x25E2,0x25E5,'AI'],[0x25E6,0x25EE,'AL'],[0x25EF,0x25EF,'AI']])
call extend(s:tmp, [[0x25F0,0x25FF,'AL'],[0x2600,0x2603,'ID'],[0x2604,0x2604,'AL']])
...
call extend(s:tmp, [[0x2614,0x2615,'ID'],[0x2616,0x2617,'AI'],[0x2618,0x2618,'ID']])
call extend(s:tmp, [[0x2619,0x2619,'AL'],[0x261A,0x261F,'ID'],[0x2620,0x2638,'AL']])
...
call extend(s:tmp, [[0x26F6,0x26F6,'AI'],[0x26F7,0x26FA,'ID'],[0x26FB,0x26FC,'AI']])
call extend(s:tmp, [[0x26FD,0x2704,'ID'],[0x2705,0x2707,'AL'],[0x2708,0x270D,'ID']])
...
call extend(s:tmp, [[0x2764,0x2767,'AL'],[0x2768,0x2768,'OP'],[0x2769,0x2769,'CL']])
call extend(s:tmp, [[0x276A,0x276A,'OP'],[0x276B,0x276B,'CL'],[0x276C,0x276C,'OP']])
call extend(s:tmp, [[0x276D,0x276D,'CL'],[0x276E,0x276E,'OP'],[0x276F,0x276F,'CL']])
call extend(s:tmp, [[0x2770,0x2770,'OP'],[0x2771,0x2771,'CL'],[0x2772,0x2772,'OP']])
call extend(s:tmp, [[0x2773,0x2773,'CL'],[0x2774,0x2774,'OP'],[0x2775,0x2775,'CL']])
call extend(s:tmp, [[0x2776,0x2793,'AI'],[0x2794,0x27C4,'AL'],[0x27C5,0x27C5,'OP']])
call extend(s:tmp, [[0x27C6,0x27C6,'CL'],[0x27C7,0x27E5,'AL'],[0x27E6,0x27E6,'OP']])
...
call extend(s:tmp, [[0x29FD,0x29FD,'CL'],[0x29FE,0x2B54,'AL'],[0x2B55,0x2B59,'AI']])
call extend(s:tmp, [[0x2B5A,0x2B73,'AL'],[0x2B76,0x2B95,'AL'],[0x2B98,0x2BB9,'AL']])
call extend(s:tmp, [[0x2BBD,0x2BC8,'AL'],[0x2BCA,0x2BD1,'AL'],[0x2C00,0x2C2E,'AL']])
call extend(s:tmp, [[0x2C30,0x2C5E,'AL'],[0x2C60,0x2CEE,'AL'],[0x2CEF,0x2CF1,'CM']])
call extend(s:tmp, [[0x2CF2,0x2CF3,'AL'],[0x2CF9,0x2CF9,'EX'],[0x2CFA,0x2CFC,'BA']])
call extend(s:tmp, [[0x2CFD,0x2CFD,'AL'],[0x2CFE,0x2CFE,'EX'],[0x2CFF,0x2CFF,'BA']])
call extend(s:tmp, [[0x2D00,0x2D25,'AL'],[0x2D27,0x2D27,'AL'],[0x2D2D,0x2D2D,'AL']])
call extend(s:tmp, [[0x2D30,0x2D67,'AL'],[0x2D6F,0x2D6F,'AL'],[0x2D70,0x2D70,'BA']])
call extend(s:tmp, [[0x2D7F,0x2D7F,'CM'],[0x2D80,0x2D96,'AL'],[0x2DA0,0x2DA6,'AL']])
call extend(s:tmp, [[0x2DA8,0x2DAE,'AL'],[0x2DB0,0x2DB6,'AL'],[0x2DB8,0x2DBE,'AL']])
call extend(s:tmp, [[0x2DC0,0x2DC6,'AL'],[0x2DC8,0x2DCE,'AL'],[0x2DD0,0x2DD6,'AL']])
call extend(s:tmp, [[0x2DD8,0x2DDE,'AL'],[0x2DE0,0x2DFF,'CM'],[0x2E00,0x2E0D,'QU']])
call extend(s:tmp, [[0x2E0E,0x2E15,'BA'],[0x2E16,0x2E16,'AL'],[0x2E17,0x2E17,'BA']])
call extend(s:tmp, [[0x2E18,0x2E18,'OP'],[0x2E19,0x2E19,'BA'],[0x2E1A,0x2E1B,'AL']])
call extend(s:tmp, [[0x2E1C,0x2E1D,'QU'],[0x2E1E,0x2E1F,'AL'],[0x2E20,0x2E21,'QU']])
call extend(s:tmp, [[0x2E22,0x2E22,'OP'],[0x2E23,0x2E23,'CL'],[0x2E24,0x2E24,'OP']])
call extend(s:tmp, [[0x2E25,0x2E25,'CL'],[0x2E26,0x2E26,'OP'],[0x2E27,0x2E27,'CL']])
call extend(s:tmp, [[0x2E28,0x2E28,'OP'],[0x2E29,0x2E29,'CL'],[0x2E2A,0x2E2D,'BA']])
call extend(s:tmp, [[0x2E2E,0x2E2E,'EX'],[0x2E2F,0x2E2F,'AL'],[0x2E30,0x2E31,'BA']])
call extend(s:tmp, [[0x2E32,0x2E32,'AL'],[0x2E33,0x2E34,'BA'],[0x2E35,0x2E39,'AL']])
call extend(s:tmp, [[0x2E3A,0x2E3B,'B2'],[0x2E3C,0x2E3E,'BA'],[0x2E3F,0x2E3F,'AL']])
call extend(s:tmp, [[0x2E40,0x2E41,'BA'],[0x2E42,0x2E42,'OP'],[0x2E80,0x2E99,'ID']])
...
call extend(s:tmp, [[0xA69F,0xA69F,'CM'],[0xA6A0,0xA6EF,'AL'],[0xA6F0,0xA6F1,'CM']])
call extend(s:tmp, [[0xA6F2,0xA6F2,'AL'],[0xA6F3,0xA6F7,'BA'],[0xA700,0xA78E,'AL']])
call extend(s:tmp, [[0xA790,0xA7AD,'AL'],[0xA7B0,0xA7B1,'AL'],[0xA7F7,0xA801,'AL']])
...
call extend(s:tmp, [[0xA9D0,0xA9D9,'NU'],[0xA9DE,0xA9DF,'AL'],[0xA9E0,0xA9EF,'SA']])
call extend(s:tmp, [[0xA9F0,0xA9F9,'NU'],[0xA9FA,0xA9FE,'SA'],[0xAA00,0xAA28,'AL']])
...
call extend(s:tmp, [[0xAA5C,0xAA5C,'AL'],[0xAA5D,0xAA5F,'BA'],[0xAA60,0xAAC2,'SA']])
call extend(s:tmp, [[0xAADB,0xAADF,'SA'],[0xAAE0,0xAAEA,'AL'],[0xAAEB,0xAAEF,'CM']])
call extend(s:tmp, [[0xAAF0,0xAAF1,'BA'],[0xAAF2,0xAAF4,'AL'],[0xAAF5,0xAAF6,'CM']])
call extend(s:tmp, [[0xAB01,0xAB06,'AL'],[0xAB09,0xAB0E,'AL'],[0xAB11,0xAB16,'AL']])
call extend(s:tmp, [[0xAB20,0xAB26,'AL'],[0xAB28,0xAB2E,'AL'],[0xAB30,0xAB5F,'AL']])
call extend(s:tmp, [[0xAB64,0xAB65,'AL'],[0xABC0,0xABE2,'AL'],[0xABE3,0xABEA,'CM']])
...
call extend(s:tmp, [[0xFE19,0xFE19,'IN'],[0xFE20,0xFE2D,'CM'],[0xFE30,0xFE34,'ID']])
...
call extend(s:tmp, [[0xFF66,0xFF66,'AL'],[0xFF67,0xFF70,'CJ'],[0xFF71,0xFF9D,'AL']])
...
call extend(s:tmp, [[0x10100,0x10102,'BA'],[0x10107,0x10133,'AL'],[0x10137,0x1018C,'AL']])
...
call extend(s:tmp, [[0x10400,0x1049D,'AL'],[0x104A0,0x104A9,'NU'],[0x10500,0x10527,'AL']])
call extend(s:tmp, [[0x10530,0x10563,'AL'],[0x1056F,0x1056F,'AL'],[0x10600,0x10736,'AL']])
call extend(s:tmp, [[0x10740,0x10755,'AL'],[0x10760,0x10767,'AL'],[0x10800,0x10805,'AL']])
call extend(s:tmp, [[0x10808,0x10808,'AL'],[0x1080A,0x10835,'AL'],[0x10837,0x10838,'AL']])
call extend(s:tmp, [[0x1083C,0x1083C,'AL'],[0x1083F,0x10855,'AL'],[0x10857,0x10857,'BA']])
call extend(s:tmp, [[0x10858,0x1089E,'AL'],[0x108A7,0x108AF,'AL'],[0x10900,0x1091B,'AL']])
call extend(s:tmp, [[0x1091F,0x1091F,'BA'],[0x10920,0x10939,'AL'],[0x1093F,0x1093F,'AL']])
call extend(s:tmp, [[0x10980,0x109B7,'AL'],[0x109BE,0x109BF,'AL'],[0x10A00,0x10A00,'AL']])
call extend(s:tmp, [[0x10A01,0x10A03,'CM'],[0x10A05,0x10A06,'CM'],[0x10A0C,0x10A0F,'CM']])
call extend(s:tmp, [[0x10A10,0x10A13,'AL'],[0x10A15,0x10A17,'AL'],[0x10A19,0x10A33,'AL']])
call extend(s:tmp, [[0x10A38,0x10A3A,'CM'],[0x10A3F,0x10A3F,'CM'],[0x10A40,0x10A47,'AL']])
call extend(s:tmp, [[0x10A50,0x10A57,'BA'],[0x10A58,0x10A58,'AL'],[0x10A60,0x10A9F,'AL']])
call extend(s:tmp, [[0x10AC0,0x10AE4,'AL'],[0x10AE5,0x10AE6,'CM'],[0x10AEB,0x10AEF,'AL']])
call extend(s:tmp, [[0x10AF0,0x10AF5,'BA'],[0x10AF6,0x10AF6,'IN'],[0x10B00,0x10B35,'AL']])
call extend(s:tmp, [[0x10B39,0x10B3F,'BA'],[0x10B40,0x10B55,'AL'],[0x10B58,0x10B72,'AL']])
call extend(s:tmp, [[0x10B78,0x10B91,'AL'],[0x10B99,0x10B9C,'AL'],[0x10BA9,0x10BAF,'AL']])
call extend(s:tmp, [[0x10C00,0x10C48,'AL'],[0x10E60,0x10E7E,'AL'],[0x11000,0x11002,'CM']])
call extend(s:tmp, [[0x11003,0x11037,'AL'],[0x11038,0x11046,'CM'],[0x11047,0x11048,'BA']])
call extend(s:tmp, [[0x11049,0x1104D,'AL'],[0x11052,0x11065,'AL'],[0x11066,0x1106F,'NU']])
call extend(s:tmp, [[0x1107F,0x11082,'CM'],[0x11083,0x110AF,'AL'],[0x110B0,0x110BA,'CM']])
call extend(s:tmp, [[0x110BB,0x110BD,'AL'],[0x110BE,0x110C1,'BA'],[0x110D0,0x110E8,'AL']])
call extend(s:tmp, [[0x110F0,0x110F9,'NU'],[0x11100,0x11102,'CM'],[0x11103,0x11126,'AL']])
call extend(s:tmp, [[0x11127,0x11134,'CM'],[0x11136,0x1113F,'NU'],[0x11140,0x11143,'BA']])
call extend(s:tmp, [[0x11150,0x11172,'AL'],[0x11173,0x11173,'CM'],[0x11174,0x11174,'AL']])
call extend(s:tmp, [[0x11175,0x11175,'BB'],[0x11176,0x11176,'AL'],[0x11180,0x11182,'CM']])
call extend(s:tmp, [[0x11183,0x111B2,'AL'],[0x111B3,0x111C0,'CM'],[0x111C1,0x111C4,'AL']])
call extend(s:tmp, [[0x111C5,0x111C6,'BA'],[0x111C7,0x111C7,'AL'],[0x111C8,0x111C8,'BA']])
...
call extend(s:tmp, [[0x1123B,0x1123C,'BA'],[0x1123D,0x1123D,'AL'],[0x112B0,0x112DE,'AL']])
call extend(s:tmp, [[0x112DF,0x112EA,'CM'],[0x112F0,0x112F9,'NU'],[0x11301,0x11303,'CM']])
call extend(s:tmp, [[0x11305,0x1130C,'AL'],[0x1130F,0x11310,'AL'],[0x11313,0x11328,'AL']])
call extend(s:tmp, [[0x1132A,0x11330,'AL'],[0x11332,0x11333,'AL'],[0x11335,0x11339,'AL']])
call extend(s:tmp, [[0x1133C,0x1133C,'CM'],[0x1133D,0x1133D,'AL'],[0x1133E,0x11344,'CM']])
call extend(s:tmp, [[0x11347,0x11348,'CM'],[0x1134B,0x1134D,'CM'],[0x11357,0x11357,'CM']])
call extend(s:tmp, [[0x1135D,0x11361,'AL'],[0x11362,0x11363,'CM'],[0x11366,0x1136C,'CM']])
call extend(s:tmp, [[0x11370,0x11374,'CM'],[0x11480,0x114AF,'AL'],[0x114B0,0x114C3,'CM']])
call extend(s:tmp, [[0x114C4,0x114C7,'AL'],[0x114D0,0x114D9,'NU'],[0x11580,0x115AE,'AL']])
call extend(s:tmp, [[0x115AF,0x115B5,'CM'],[0x115B8,0x115C0,'CM'],[0x115C1,0x115C1,'BB']])
call extend(s:tmp, [[0x115C2,0x115C3,'BA'],[0x115C4,0x115C5,'EX'],[0x115C6,0x115C8,'AL']])
call extend(s:tmp, [[0x115C9,0x115C9,'BA'],[0x11600,0x1162F,'AL'],[0x11630,0x11640,'CM']])
call extend(s:tmp, [[0x11641,0x11642,'BA'],[0x11643,0x11644,'AL'],[0x11650,0x11659,'NU']])
call extend(s:tmp, [[0x11680,0x116AA,'AL'],[0x116AB,0x116B7,'CM'],[0x116C0,0x116C9,'NU']])
call extend(s:tmp, [[0x118A0,0x118DF,'AL'],[0x118E0,0x118E9,'NU'],[0x118EA,0x118F2,'AL']])
call extend(s:tmp, [[0x118FF,0x118FF,'AL'],[0x11AC0,0x11AF8,'AL'],[0x12000,0x12398,'AL']])
call extend(s:tmp, [[0x12400,0x1246E,'AL'],[0x12470,0x12474,'BA'],[0x13000,0x13257,'AL']])
...
call extend(s:tmp, [[0x1337C,0x1342E,'AL'],[0x16800,0x16A38,'AL'],[0x16A40,0x16A5E,'AL']])
call extend(s:tmp, [[0x16A60,0x16A69,'NU'],[0x16A6E,0x16A6F,'BA'],[0x16AD0,0x16AED,'AL']])
call extend(s:tmp, [[0x16AF0,0x16AF4,'CM'],[0x16AF5,0x16AF5,'BA'],[0x16B00,0x16B2F,'AL']])
call extend(s:tmp, [[0x16B30,0x16B36,'CM'],[0x16B37,0x16B39,'BA'],[0x16B3A,0x16B43,'AL']])
call extend(s:tmp, [[0x16B44,0x16B44,'BA'],[0x16B45,0x16B45,'AL'],[0x16B50,0x16B59,'NU']])
call extend(s:tmp, [[0x16B5B,0x16B61,'AL'],[0x16B63,0x16B77,'AL'],[0x16B7D,0x16B8F,'AL']])
call extend(s:tmp, [[0x16F00,0x16F44,'AL'],[0x16F50,0x16F50,'AL'],[0x16F51,0x16F7E,'CM']])
call extend(s:tmp, [[0x16F8F,0x16F92,'CM'],[0x16F93,0x16F9F,'AL'],[0x1B000,0x1B001,'ID']])
call extend(s:tmp, [[0x1BC00,0x1BC6A,'AL'],[0x1BC70,0x1BC7C,'AL'],[0x1BC80,0x1BC88,'AL']])
call extend(s:tmp, [[0x1BC90,0x1BC99,'AL'],[0x1BC9C,0x1BC9C,'AL'],[0x1BC9D,0x1BC9E,'CM']])
call extend(s:tmp, [[0x1BC9F,0x1BC9F,'BA'],[0x1BCA0,0x1BCA3,'CM'],[0x1D000,0x1D0F5,'AL']])
call extend(s:tmp, [[0x1D100,0x1D126,'AL'],[0x1D129,0x1D164,'AL'],[0x1D165,0x1D169,'CM']])
call extend(s:tmp, [[0x1D16A,0x1D16C,'AL'],[0x1D16D,0x1D182,'CM'],[0x1D183,0x1D184,'AL']])
call extend(s:tmp, [[0x1D185,0x1D18B,'CM'],[0x1D18C,0x1D1A9,'AL'],[0x1D1AA,0x1D1AD,'CM']])
call extend(s:tmp, [[0x1D1AE,0x1D1DD,'AL'],[0x1D200,0x1D241,'AL'],[0x1D242,0x1D244,'CM']])
call extend(s:tmp, [[0x1D245,0x1D245,'AL'],[0x1D300,0x1D356,'AL'],[0x1D360,0x1D371,'AL']])
call extend(s:tmp, [[0x1D400,0x1D454,'AL'],[0x1D456,0x1D49C,'AL'],[0x1D49E,0x1D49F,'AL']])
call extend(s:tmp, [[0x1D4A2,0x1D4A2,'AL'],[0x1D4A5,0x1D4A6,'AL'],[0x1D4A9,0x1D4AC,'AL']])
call extend(s:tmp, [[0x1D4AE,0x1D4B9,'AL'],[0x1D4BB,0x1D4BB,'AL'],[0x1D4BD,0x1D4C3,'AL']])
call extend(s:tmp, [[0x1D4C5,0x1D505,'AL'],[0x1D507,0x1D50A,'AL'],[0x1D50D,0x1D514,'AL']])
call extend(s:tmp, [[0x1D516,0x1D51C,'AL'],[0x1D51E,0x1D539,'AL'],[0x1D53B,0x1D53E,'AL']])
call extend(s:tmp, [[0x1D540,0x1D544,'AL'],[0x1D546,0x1D546,'AL'],[0x1D54A,0x1D550,'AL']])
call extend(s:tmp, [[0x1D552,0x1D6A5,'AL'],[0x1D6A8,0x1D7CB,'AL'],[0x1D7CE,0x1D7FF,'NU']])
call extend(s:tmp, [[0x1E800,0x1E8C4,'AL'],[0x1E8C7,0x1E8CF,'AL'],[0x1E8D0,0x1E8D6,'CM']])
call extend(s:tmp, [[0x1EE00,0x1EE03,'AL'],[0x1EE05,0x1EE1F,'AL'],[0x1EE21,0x1EE22,'AL']])
call extend(s:tmp, [[0x1EE24,0x1EE24,'AL'],[0x1EE27,0x1EE27,'AL'],[0x1EE29,0x1EE32,'AL']])
call extend(s:tmp, [[0x1EE34,0x1EE37,'AL'],[0x1EE39,0x1EE39,'AL'],[0x1EE3B,0x1EE3B,'AL']])
call extend(s:tmp, [[0x1EE42,0x1EE42,'AL'],[0x1EE47,0x1EE47,'AL'],[0x1EE49,0x1EE49,'AL']])
call extend(s:tmp, [[0x1EE4B,0x1EE4B,'AL'],[0x1EE4D,0x1EE4F,'AL'],[0x1EE51,0x1EE52,'AL']])
call extend(s:tmp, [[0x1EE54,0x1EE54,'AL'],[0x1EE57,0x1EE57,'AL'],[0x1EE59,0x1EE59,'AL']])
call extend(s:tmp, [[0x1EE5B,0x1EE5B,'AL'],[0x1EE5D,0x1EE5D,'AL'],[0x1EE5F,0x1EE5F,'AL']])
call extend(s:tmp, [[0x1EE61,0x1EE62,'AL'],[0x1EE64,0x1EE64,'AL'],[0x1EE67,0x1EE6A,'AL']])
call extend(s:tmp, [[0x1EE6C,0x1EE72,'AL'],[0x1EE74,0x1EE77,'AL'],[0x1EE79,0x1EE7C,'AL']])
call extend(s:tmp, [[0x1EE7E,0x1EE7E,'AL'],[0x1EE80,0x1EE89,'AL'],[0x1EE8B,0x1EE9B,'AL']])
call extend(s:tmp, [[0x1EEA1,0x1EEA3,'AL'],[0x1EEA5,0x1EEA9,'AL'],[0x1EEAB,0x1EEBB,'AL']])
call extend(s:tmp, [[0x1EEF0,0x1EEF1,'AL'],[0x1F000,0x1F02B,'ID'],[0x1F030,0x1F093,'ID']])
call extend(s:tmp, [[0x1F0A0,0x1F0AE,'ID'],[0x1F0B1,0x1F0BF,'ID'],[0x1F0C1,0x1F0CF,'ID']])
call extend(s:tmp, [[0x1F0D1,0x1F0F5,'ID'],[0x1F100,0x1F10C,'AI'],[0x1F110,0x1F12D,'AI']])
call extend(s:tmp, [[0x1F12E,0x1F12E,'AL'],[0x1F130,0x1F169,'AI'],[0x1F16A,0x1F16B,'AL']])
call extend(s:tmp, [[0x1F170,0x1F19A,'AI'],[0x1F1E6,0x1F1FF,'RI'],[0x1F200,0x1F202,'ID']])
call extend(s:tmp, [[0x1F210,0x1F23A,'ID'],[0x1F240,0x1F248,'ID'],[0x1F250,0x1F251,'ID']])
call extend(s:tmp, [[0x1F300,0x1F32C,'ID'],[0x1F330,0x1F37D,'ID'],[0x1F380,0x1F39B,'ID']])
call extend(s:tmp, [[0x1F39C,0x1F39D,'AL'],[0x1F39E,0x1F3B4,'ID'],[0x1F3B5,0x1F3B6,'AL']])
call extend(s:tmp, [[0x1F3B7,0x1F3BB,'ID'],[0x1F3BC,0x1F3BC,'AL'],[0x1F3BD,0x1F3CE,'ID']])
call extend(s:tmp, [[0x1F3D4,0x1F3F7,'ID'],[0x1F400,0x1F49F,'ID'],[0x1F4A0,0x1F4A0,'AL']])
call extend(s:tmp, [[0x1F4A1,0x1F4A1,'ID'],[0x1F4A2,0x1F4A2,'AL'],[0x1F4A3,0x1F4A3,'ID']])
call extend(s:tmp, [[0x1F4A4,0x1F4A4,'AL'],[0x1F4A5,0x1F4AE,'ID'],[0x1F4AF,0x1F4AF,'AL']])
call extend(s:tmp, [[0x1F4B0,0x1F4B0,'ID'],[0x1F4B1,0x1F4B2,'AL'],[0x1F4B3,0x1F4FE,'ID']])
call extend(s:tmp, [[0x1F500,0x1F506,'AL'],[0x1F507,0x1F516,'ID'],[0x1F517,0x1F524,'AL']])
call extend(s:tmp, [[0x1F525,0x1F531,'ID'],[0x1F532,0x1F549,'AL'],[0x1F54A,0x1F54A,'ID']])
call extend(s:tmp, [[0x1F550,0x1F579,'ID'],[0x1F57B,0x1F5A3,'ID'],[0x1F5A5,0x1F5D3,'ID']])
call extend(s:tmp, [[0x1F5D4,0x1F5DB,'AL'],[0x1F5DC,0x1F5F3,'ID'],[0x1F5F4,0x1F5F9,'AL']])
call extend(s:tmp, [[0x1F5FA,0x1F642,'ID'],[0x1F645,0x1F64F,'ID'],[0x1F650,0x1F675,'AL']])
call extend(s:tmp, [[0x1F676,0x1F678,'QU'],[0x1F679,0x1F67B,'NS'],[0x1F67C,0x1F67F,'AL']])
call extend(s:tmp, [[0x1F680,0x1F6CF,'ID'],[0x1F6E0,0x1F6EC,'ID'],[0x1F6F0,0x1F6F3,'ID']])
call extend(s:tmp, [[0x1F700,0x1F773,'AL'],[0x1F780,0x1F7D4,'AL'],[0x1F800,0x1F80B,'AL']])
call extend(s:tmp, [[0x1F810,0x1F847,'AL'],[0x1F850,0x1F859,'AL'],[0x1F860,0x1F887,'AL']])
...
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','CM','AL','CM','CM','CM','CM','CM','CM','CM','CM','CM','AL','CM','CM','CM','AL','CM','CM','CM','CM','CM','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','XX','XX','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM'])
...
call add(s:tmp, ['XX','CM','CM','CM','XX','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','XX','AL','AL','XX','AL','AL','XX','XX','CM','XX','CM','CM','CM','CM','CM','XX','XX','XX','XX','CM','CM','XX','XX','CM','CM','CM','XX','XX','XX','CM','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','XX','AL','XX','XX','XX','XX','XX','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','CM','CM','AL','AL','AL','CM','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','CM','CM','CM','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','XX','AL','AL','AL','AL','AL','XX','XX','CM','AL','CM','CM','CM','CM','CM','CM','CM','CM','XX','CM','CM','CM','XX','CM','CM','CM','XX','XX','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','CM','CM','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','AL','PR','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['CM','CM','CM','CM','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','AL','CM','CM','CM','CM','CM','CM','CM','XX','CM','CM','CM','XX','CM','CM','CM','CM','XX','XX','XX','XX','XX','XX','XX','CM','CM','XX','AL','AL','XX','XX','XX','XX','XX','XX','AL','AL','CM','CM','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','CM','CM','CM','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','XX','XX','CM','AL','CM','CM','CM','CM','CM','CM','CM','XX','CM','CM','CM','XX','CM','CM','CM','CM','XX','XX','XX','XX','XX','XX','XX','CM','CM','XX','XX','XX','XX','XX','XX','XX','AL','XX','AL','AL','CM','CM','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','XX','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
call add(s:tmp, ['XX','CM','CM','CM','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','AL','CM','CM','CM','CM','CM','CM','CM','XX','CM','CM','CM','XX','CM','CM','CM','CM','AL','XX','XX','XX','XX','XX','XX','XX','XX','CM','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','CM','CM','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','AL','AL','AL','AL','AL','AL','XX','XX','XX','PO','AL','AL','AL','AL','AL','AL','XX','XX','CM','CM','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','XX','XX','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','CM','XX','XX','XX','XX','CM','CM','CM','CM','CM','CM','XX','CM','XX','CM','CM','CM','CM','CM','CM','CM','CM','XX','XX','XX','XX','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','XX','XX','CM','CM','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','XX','XX','XX','BA','BA','BA','BA','BA','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','XX','XX','XX','AL','AL','AL','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','BA','BA','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','CM','CM','CM','AL','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','AL','AL','AL','AL','CM','AL','AL','AL','AL','CM','CM','CM','AL','AL','XX','CM','CM','XX','XX','XX','XX','XX','XX'])
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','XX','XX','XX','XX','XX','XX','CM','CM','CM','CM'])
call add(s:tmp, ['AL'])
...
call add(s:tmp, ['BA','BA','BA','BA','BA','BA','BA','GL','BA','BA','BA','ZW','CM','CM','CM','CM','BA','GL','BA','BA','B2','AI','AI','AL','QU','QU','OP','QU','QU','QU','OP','QU','AI','AI','AL','AL','IN','IN','IN','BA','BK','BK','CM','CM','CM','CM','CM','GL','PO','PO','PO','PO','PO','PO','PO','PO','AL','QU','QU','AI','NS','NS','AL','AL','AL','AL','AL','AL','IS','OP','CL','NS','NS','NS','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','BA','AL','BA','BA','BA','BA','AL','BA','BA','BA','WJ','AL','AL','AL','AL','XX','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','AL','AL','XX','XX','AI','AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','AI','AL','AI','AI','AI','AI','AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','PR','PR','PR','PR','PR','PR','PR','PO','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PO','PR','PR','PR','PR','PO','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','PR','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','OP','CL','AL','AL','AL','AL','AL','AL','AI','AL','AL','AL','AL','AL','AL','AL','ID','ID','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','ID','ID','ID','ID','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['ID','ID','ID','ID','AL','AI','AI','AL','AL','AI','AL','AL','AL','AL','AI','AI','AL','AL','AL','AL','ID','ID','AI','AI','ID','AL','ID','ID','ID','ID','ID','ID','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','ID','ID','ID','AL','AL','AL','AL','AI','AL','AI','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AI','AI','AL','AI','AI','AI','AL','AI','ID','AI','AI','AL','AI','AI','AL','AI','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','ID','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AI','AI','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','AI','AI','AI','AI','ID','AL','ID','ID','ID','AI','ID','ID','AI','AI','AI','ID','ID','AI','AI','ID','AI','AI','ID','ID','ID','AL','AI','AL','AL','AL','AL','AI','AI','ID','AI','AI','AI','AI','AI','AI','ID','ID','ID','ID','ID','AI','ID','ID','ID','ID','AI','AI','ID','ID','ID'])
call add(s:tmp, ['ID','ID','ID','ID','ID','AL','AL','AL','ID','ID','ID','ID','ID','ID','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AI','AL','AL','AL','QU','QU','QU','QU','QU','QU','AL','EX','EX','AL','AL','AL','AL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AI','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL'])
call add(s:tmp, ['AL'])
...
call add(s:tmp, ['AL'])
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AI','AI','AI','AI','AI','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['QU','QU','QU','QU','QU','QU','QU','QU','QU','QU','QU','QU','QU','QU','BA','BA','BA','BA','BA','BA','BA','BA','AL','BA','OP','BA','AL','AL','QU','QU','AL','AL','QU','QU','OP','CL','OP','CL','OP','CL','OP','CL','BA','BA','BA','BA','EX','AL','BA','BA','AL','BA','BA','AL','AL','AL','AL','AL','B2','B2','BA','BA','BA','AL','BA','BA','OP','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','XX','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['AL'])
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','BA','EX','BA','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','CM','AL','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','CM','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','AL','BA','BA','BA','BA','BA','XX','XX','XX','XX','XX','XX','XX','XX'])
call add(s:tmp, ['AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL'])
...
call add(s:tmp, ['XX','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','CM','CM','CM','CM','CM','CM','CM','CM','BA','CM','CM','XX','XX','NU','NU','NU','NU','NU','NU','NU','NU','NU','NU','XX','XX','XX','XX','XX','XX'])
...
call add(s:tmp, ['CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','IS','CL','CL','IS','IS','EX','EX','OP','CL','IN','XX','XX','XX','XX','XX','XX','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','CM','XX','XX','ID','ID','ID','ID','ID','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','OP','CL','ID','ID','OP','CL','ID','ID','ID','ID','ID','ID','ID','CL','ID','CL','XX','NS','NS','EX','EX','ID','OP','CL','OP','CL','OP','CL','ID','ID','ID','ID','ID','ID','ID','ID','XX','ID','PR','PO','ID','XX','XX','XX','XX','AL','AL','AL','AL','AL','XX','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','WJ'])
call add(s:tmp, ['XX','EX','ID','ID','PR','PO','ID','ID','OP','CL','ID','ID','CL','ID','CL','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','NS','NS','ID','ID','ID','EX','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','OP','ID','CL','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','ID','OP','ID','CL','ID','OP','CL','CL','OP','CL','CL','NS','AL','CJ','CJ','CJ','CJ','CJ','CJ','CJ','CJ','CJ','CJ','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','NS','NS','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','AL','AL','AL','XX','XX','AL','AL','AL','XX','XX','XX','PO','PR','ID','ID','ID','PR','PR','XX','AL','AL','AL','AL','AL','AL','AL','XX','XX','XX','XX','XX','XX','XX','XX','XX','XX','CM','CM','CM','CB','AI','XX','XX'])
